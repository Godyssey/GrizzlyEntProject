...
/*    public static void main(String[] args) {
    ...
    public EmployeeMainMenu() {
		...
		sl_contentPane.putConstraint(SpringLayout.NORTH, viewCustomerMessages, 34, SpringLayout.SOUTH, viewAllEquipment);
		...
		sl_contentPane.putConstraint(SpringLayout.NORTH, scheduleEquipment, 34, SpringLayout.SOUTH, viewCustomerMessages);
